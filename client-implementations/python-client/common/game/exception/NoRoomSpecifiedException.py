...
class NoRoomSpecifiedException(GameException):
    """ generated source for class NoRoomSpecifiedException """
    serialVersionUID = 5009842166122191121L

    @overloaded
    def __init__(self):
        """ generated source for method __init__ """
        super(NoRoomSpecifiedException, self).__init__()

    @__init__.register(object, str, Throwable)
    def __init___0(self, message, cause):
        """ generated source for method __init___0 """
        super(NoRoomSpecifiedException, self).__init__(cause)

    @__init__.register(object, str)
    def __init___1(self, message):
        """ generated source for method __init___1 """
        super(NoRoomSpecifiedException, self).__init__(message)
